...
class Stock_Manager_Admin {
  ...
  /**
	...
	public function add_plugin_admin_menu() {
		...
		add_menu_page(
			__( 'Product Manager', $this->plugin_slug ),
			__( 'Product Manager', $this->plugin_slug ),
			'manage_woocommerce',
			'stock-manager',
		...
		add_submenu_page(
			'stock-manager',
      __( 'Product Import', $this->plugin_slug ),
			__( 'Product Import', $this->plugin_slug ),
			'manage_woocommerce',
      ...
      add_submenu_page(
			'stock-manager',
      __( 'Stock Adjust History', $this->plugin_slug ),
			__( 'Stock Adjust History', $this->plugin_slug ),
			'manage_woocommerce',
			'stock-manager-inventory-history',
			array( $this, 'display_inventory_history_page' )
		);
  ...
  /**
	...
	public function display_import_export_page() {
	  ...
	  /**
	 * Render the inventory history page for this plugin - Developed by Fan
	 *
	 * @since    1.0.0
	 */
	public function display_inventory_history_page() {
		include_once( 'views/inventory-history.php' );
	}
